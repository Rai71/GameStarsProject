...
function showSlides(n) {
  let i;
  let slides = document.getElementsByClassName("raiReview3slide");
...
container.innerHTML = `    
    <section class="raiGameLayout">
        <h1>${game.title}</h1>
        <section class="raiSlideGame1">
            <section class="raiReview3slide">
            ...
            <section class="raiReview3slide">
                <img src="${game.image3}" alt="${game.title}" class="raiGameImage">
            </section>
            <section class="raiReview3slide">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/o1780AqAa20?si=ibdN1KgIEktzwvLl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </section>
